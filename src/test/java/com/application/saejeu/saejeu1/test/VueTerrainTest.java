...
import java.io.IOException;
    ...
    public class VueTerrainTest {
        private Environnement environnement; // Déclare une variable pour stocker l'environnement.
        private TilePane tilePane; // Déclare une variable pour stocker le TilePane.
        private String nomFichier; // Déclare une variable pour stocker le nom du fichier.
