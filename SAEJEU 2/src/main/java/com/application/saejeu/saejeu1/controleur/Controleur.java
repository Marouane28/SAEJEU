...
public class Controleur implements Initializable {
    ...
    @FXML
    private Label labelPièces, labelR, labelG, labelM;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        this.labelPièces.textProperty().bind(this.environnement.getPropertyPièces().asString());
        ...
        KeyFrame kf = new KeyFrame(
                ...
                (ev -> {
                    if (temps % 10 == 0){
                        ...
                        System.out.println("pièces: " + this.environnement.getPropertyPièces());
